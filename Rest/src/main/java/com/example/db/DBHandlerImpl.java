...
public class DBHandlerImpl implements DBHandler {
  ...
  @Override
  public Boolean changeColumnName(int tableIndex, int columnIndex, String newName){
    return DatabaseManager.getInstance().changeColumnName(tableIndex, columnIndex, newName);
  }
}
